...
<%
	...
	writer = multi1.getParameter("writer");
	subject = multi1.getParameter("subject");
	email = multi1.getParameter("email");
	password = multi1.getParameter("password");
	content = multi1.getParameter("content");
